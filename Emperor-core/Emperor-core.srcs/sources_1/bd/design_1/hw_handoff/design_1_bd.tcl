...
CONFIG.CONST_VAL {1} \
  ...
  connect_bd_intf_net -intf_net core_top_0_ADDSUB_A [get_bd_intf_pins core_top_0/ADDSUB_A] [get_bd_intf_pins floating_point_0/S_AXIS_A]
  connect_bd_intf_net -intf_net core_top_0_ADDSUB_B [get_bd_intf_pins core_top_0/ADDSUB_B] [get_bd_intf_pins floating_point_0/S_AXIS_B]
  connect_bd_intf_net -intf_net core_top_0_ADDSUB_OP [get_bd_intf_pins core_top_0/ADDSUB_OP] [get_bd_intf_pins floating_point_0/S_AXIS_OPERATION]
  ...
  connect_bd_intf_net -intf_net core_top_0_DIV_A [get_bd_intf_pins core_top_0/DIV_A] [get_bd_intf_pins floating_point_3/S_AXIS_A]
  connect_bd_intf_net -intf_net core_top_0_DIV_B [get_bd_intf_pins core_top_0/DIV_B] [get_bd_intf_pins floating_point_3/S_AXIS_B]
  connect_bd_intf_net -intf_net core_top_0_FCVTSW_A [get_bd_intf_pins core_top_0/FCVTSW_A] [get_bd_intf_pins floating_point_2/S_AXIS_A]
  ...
  connect_bd_intf_net -intf_net core_top_0_MUL_A [get_bd_intf_pins core_top_0/MUL_A] [get_bd_intf_pins floating_point_7/S_AXIS_A]
  connect_bd_intf_net -intf_net core_top_0_MUL_B [get_bd_intf_pins core_top_0/MUL_B] [get_bd_intf_pins floating_point_7/S_AXIS_B]
  ...
  connect_bd_intf_net -intf_net floating_point_2_M_AXIS_RESULT [get_bd_intf_pins core_top_0/FCVTSW_R] [get_bd_intf_pins floating_point_2/M_AXIS_RESULT]
  connect_bd_intf_net -intf_net floating_point_3_M_AXIS_RESULT [get_bd_intf_pins core_top_0/DIV_R] [get_bd_intf_pins floating_point_3/M_AXIS_RESULT]
  ...
  connect_bd_intf_net -intf_net floating_point_7_M_AXIS_RESULT [get_bd_intf_pins core_top_0/MUL_R] [get_bd_intf_pins floating_point_7/M_AXIS_RESULT]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_1/clka] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins core_top_0/CLK] [get_bd_pins core_top_0_axi_periph/ACLK] [get_bd_pins core_top_0_axi_periph/M00_ACLK] [get_bd_pins core_top_0_axi_periph/S00_ACLK] [get_bd_pins floating_point_0/aclk] [get_bd_pins floating_point_1/aclk] [get_bd_pins floating_point_2/aclk] [get_bd_pins floating_point_3/aclk] [get_bd_pins floating_point_5/aclk] [get_bd_pins floating_point_6/aclk] [get_bd_pins floating_point_7/aclk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins core_top_0/RST_N] [get_bd_pins floating_point_0/aresetn] [get_bd_pins floating_point_1/aresetn] [get_bd_pins floating_point_2/aresetn] [get_bd_pins floating_point_3/aresetn] [get_bd_pins floating_point_5/aresetn] [get_bd_pins floating_point_6/aresetn] [get_bd_pins floating_point_7/aresetn] [get_bd_pins rst_clk_wiz_0_100M/dcm_locked]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_interconnect_aresetn [get_bd_pins core_top_0_axi_periph/ARESETN] [get_bd_pins rst_clk_wiz_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins core_top_0_axi_periph/M00_ARESETN] [get_bd_pins core_top_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn]
...
#  -string -flagsOSRD
preplace port default_sysclk_300 -pg 1 -y 1130 -defaultsOSRD
preplace port rs232_uart -pg 1 -y 820 -defaultsOSRD
preplace port reset -pg 1 -y 1060 -defaultsOSRD
preplace inst core_top_0 -pg 1 -lvl 3 -y 270 -defaultsOSRD
preplace inst rst_clk_wiz_0_100M -pg 1 -lvl 3 -y 970 -defaultsOSRD
preplace inst floating_point_0 -pg 1 -lvl 2 -y 130 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 3 -y 660 -defaultsOSRD
preplace inst floating_point_1 -pg 1 -lvl 2 -y 310 -defaultsOSRD
preplace inst core_top_0_axi_periph -pg 1 -lvl 4 -y 810 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 3 -y 560 -defaultsOSRD
preplace inst floating_point_2 -pg 1 -lvl 2 -y 980 -defaultsOSRD
preplace inst floating_point_3 -pg 1 -lvl 2 -y 650 -defaultsOSRD
preplace inst blk_mem_gen_0 -pg 1 -lvl 4 -y 580 -defaultsOSRD
preplace inst floating_point_5 -pg 1 -lvl 2 -y 1130 -defaultsOSRD
preplace inst blk_mem_gen_1 -pg 1 -lvl 4 -y 390 -defaultsOSRD
preplace inst floating_point_6 -pg 1 -lvl 2 -y 1280 -defaultsOSRD
preplace inst floating_point_7 -pg 1 -lvl 2 -y 820 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 5 -y 830 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -y 1140 -defaultsOSRD
preplace netloc floating_point_3_M_AXIS_RESULT 1 2 1 680
preplace netloc core_top_0_ADDSUB_OP 1 1 3 250 900 750J 870 1210
preplace netloc xlconstant_1_dout 1 3 1 1220J
preplace netloc core_top_0_MEM_ADDR 1 3 1 1220
preplace netloc default_sysclk_300_1 1 0 1 NJ
preplace netloc core_top_0_MEM_WE 1 3 1 1230
preplace netloc blk_mem_gen_1_douta 1 2 2 790 720 1260J
preplace netloc clk_wiz_0_locked 1 1 2 230 410 760
preplace netloc core_top_0_FCVTWS_A 1 1 3 270 490 NJ 490 1110
preplace netloc floating_point_7_M_AXIS_RESULT 1 2 1 700
preplace netloc core_top_0_MUL_A 1 1 3 330 510 NJ 510 1130
preplace netloc core_top_0_COMP_OP 1 1 3 320 740 NJ 740 1180
preplace netloc core_top_0_MUL_B 1 1 3 340 570 710J 610 1120
preplace netloc core_top_0_axi_periph_M00_AXI 1 4 1 N
preplace netloc floating_point_5_M_AXIS_RESULT 1 2 1 720
preplace netloc core_top_0_MEM_DATA 1 3 1 1230
preplace netloc core_top_0_FCVTSW_A 1 1 3 300 500 NJ 500 1140
preplace netloc floating_point_1_M_AXIS_RESULT 1 2 1 670
preplace netloc xlconstant_0_dout 1 3 1 1290J
preplace netloc core_top_0_COMP_A 1 1 3 260 910 740J 830 1200
preplace netloc clk_wiz_0_clk_out1 1 1 4 220 400 770 1130 1270 1130 1570
preplace netloc axi_uartlite_0_UART 1 5 1 N
preplace netloc core_top_0_DIV_A 1 1 3 280 30 NJ 30 1170
preplace netloc core_top_0_COMP_B 1 1 3 310 730 NJ 730 1190
preplace netloc core_top_0_ADDSUB_A 1 1 3 220 10 NJ 10 1210
preplace netloc blk_mem_gen_0_douta 1 2 2 780 710 1280J
preplace netloc core_top_0_I_MEM_ADDR 1 3 1 1240
preplace netloc core_top_0_FSQRTS_A 1 1 3 240 220 660J 50 1150
preplace netloc core_top_0_DIV_B 1 1 3 290 40 NJ 40 1160
preplace netloc core_top_0_ADDSUB_B 1 1 3 230 20 NJ 20 1180
preplace netloc floating_point_0_M_AXIS_RESULT 1 2 1 670
preplace netloc core_top_0_interface_aximm 1 3 1 1250
preplace netloc floating_point_6_M_AXIS_RESULT 1 2 1 730
preplace netloc rst_clk_wiz_0_100M_interconnect_aresetn 1 3 1 1280
preplace netloc rst_clk_wiz_0_100M_peripheral_aresetn 1 3 2 1290 1010 1580
preplace netloc reset_1 1 0 3 20 1060 NJ 1060 790
preplace netloc floating_point_2_M_AXIS_RESULT 1 2 1 690
levelinfo -pg 1 0 120 500 950 1430 1680 1800 -top 0 -bot 1340
",
}
